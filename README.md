...
<body>
    ...
    <script>
        ...
        function storeProductData(productData) {
            axios.post("https://crudcrud.com/api/b84c5f6c11fb477aababec9975c852f1/apointmentData", productData)
                .then((response) => {
        ...
        function deleteProductData(index) {
            axios.delete(`https://crudcrud.com/api/b84c5f6c11fb477aababec9975c852f1/apointmentData/${index}`)
                .then((response) => {
